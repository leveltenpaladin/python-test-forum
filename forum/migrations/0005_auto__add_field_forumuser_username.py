...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumUser.username'
        db.add_column(u'forum_forumuser', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForumUser.username'
        db.delete_column(u'forum_forumuser', 'username')
