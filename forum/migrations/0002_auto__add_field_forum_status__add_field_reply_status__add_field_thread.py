...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.status'
        db.add_column(u'forum_forum', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Reply.status'
        db.add_column(u'forum_reply', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Thread.status'
        db.add_column(u'forum_thread', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.status'
        db.delete_column(u'forum_forum', 'status')

        # Deleting field 'Reply.status'
        db.delete_column(u'forum_reply', 'status')

        # Deleting field 'Thread.status'
        db.delete_column(u'forum_thread', 'status')
